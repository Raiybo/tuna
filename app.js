...
async function load() {
  ...
  } catch (e) { statusEl.textContent = "Could not load data/*.json â€” serve the repo root (see README)."; return; }
  ...
  statusEl.textContent = `As of ${new Date(nowMs).toISOString().slice(0, 16).replace("T", " ")}Z Â· ` +
